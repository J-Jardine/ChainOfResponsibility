 ...
 * @author t7077222
 */
public class MediumLorryCourier implements VehicleChain{
    ...
    public boolean vehicleChain(Vehicle vehicle)
    {
        ...
        if (vehicle.getOrderWeight() < 2000)
        {
            if (isFull == false)
            {
                ...
                {
                    increment();
                    System.out.println("A Medium Lorry With: " + vehicle.toString() 
                                + " ,Capacity [" + vehicleCount
                                + "/" + maxVehicle + "]");
                } else
                {
                    isFull = true;
                    System.out.println("All Of The Medium Lorrys Are In Use Passing The Request To The Next Available Vehicle!");
                }
            }
        } else
        {
