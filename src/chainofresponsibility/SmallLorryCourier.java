 ...
 * @author t7077222
 */
public class SmallLorryCourier implements VehicleChain{
    ...
    public boolean vehicleChain(Vehicle vehicle)
    {
        ...
        if (vehicle.getOrderWeight() < 1000)
        {
            if (isFull == false)
            {
                ...
                {
                    increment();
                    System.out.println("A Small Lorry With: " + vehicle.toString() 
                                + " ,Capacity [" + vehicleCount
                                + "/" + maxVehicle + "]");
                } else
                {
                    isFull = true;
                    System.out.println("All Of The Small Lorrys Are In Use Passing The Request To The Next Available Vehicle!");
                }
            }
        } else
        {
